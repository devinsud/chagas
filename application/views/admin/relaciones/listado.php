...
<div class="top-bar">
    ...
    <a href="<?php echo base_url(); ?>admin/relaciones/crea" class="button nuevo">Nueva relaci&oacute;n</a>
    <?php } ?>
    <h1 class="titulo">Administraci&oacute;n de Relaciones Familiares</h1>
            ...
            if (isset($items) && count($items) > 0 ) {
                foreach ($items as $u) {
                    ...
                    <tr>
                        ...
                        <td class="url_fuente"> <?php echo $u->relacion; ?> </td>
