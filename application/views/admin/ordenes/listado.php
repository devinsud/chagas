...
foreach ($sedes as $sede1) {
	...
	?>
										       <a href="<?php echo base_url();?>admin/viviendas/listas/<?php echo $sede1->id;?>" class="button nuevo">Crear Listas para la sede <?php echo $sede1->localidad;
	?></a>
	<?php
}
//} ?>
		...
		foreach ($items as $u) {
			...
			?>
																								                    ...
																								                    <td class="herramientas_fuentes">
																								                        ...
																								                        <a href="<?php echo base_url();?>admin/ordenes/ver2/<?php echo $u->id;?>" ><img src="<?php echo base_url();?>assets/img/15105.png" width="16" height="16" alt="ver" />  </a> |
																									                            <a href="<?php echo base_url();?>admin/ordenes/ver/<?php echo $u->id;?>" ><img src="<?php echo base_url();?>assets/img/ojo.png" width="16" height="16" alt="ver" />  </a> |
			<?php if ($u->tipo == 'Inspección') {?>
																															                            <a href="<?php echo base_url();?>admin/ordenes/carga_inspeccion/<?php echo $u->id;?>" ><img src="<?php echo base_url();?>assets/img/edit-icon.gif" width="16" height="16" alt="ver" />  </a> |
				<?php } else {?>
								 |<a href="<?php echo base_url();?>admin/ordenes/procesar/<?php echo $u->id;?>" ><img src="<?php echo base_url();?>assets/img/edit-icon.gif" width="16" height="16" alt="ver" />  </a> |
				<?php }?>
																									                            <a href="<?php echo base_url();?>admin/ordenes/imprimir/<?php echo $u->id;?>" target="_blank" ><img src="<?php echo base_url();?>assets/img/printer.png" width="16" height="16" alt="imprimir" />  </a>
