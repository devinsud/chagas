...
<?php 
    ...
    <?php  } ?>
            <a href="<?php echo base_url();?>admin/ordenes/elimina_orden/<?php echo $orden->id; ?>"><img src="<?php echo base_url();?>assets/img/hr.gif" alt=""> Eliminar orden</a>
<?php }?>
    ...
    foreach ($viviendas as $v) { 
                    ...
                    $esPos = $this->vivienda->esPos1($v);
                    $estado = $this->vivienda->getEstado($v);
                    //aca tengo que poner una variable para colectar el dato
    ...
    for (i = 0; i < locations.length; i++) {  
        ...
        if(locations[i][4]){
            ...
            if(locations[i][6]=="receptiva"){
                icono = var receptiva_positivo
            }else if(locations[i][6]=="desarmada"){
                icono = var desmoronada_positivo
            }else if(locations[i][6]=="cerrada"){
                icono = var cerrada_positivo
            }else if(locations[i][6]=="renuente"){
                icono = var renuente_positivo
            }else if(locations[i][6]=="deshabitada"){
                icono = var deshabitada_positivo  
            }
