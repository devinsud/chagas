...
<div class="top-bar">
    <?php if($admin==1 ){ 
        ...
        ?>
       <a href="<?php echo base_url(); ?>admin/viviendas/listas/<?php echo $sede1->id; ?>" class="button nuevo">Crear Listas para la sede <?php echo $sede1->localidad; ?></a>
    <?php 
        }
    } ?>
        ...
        if(!is_null($items)){
            if (isset($items) && count($items) > 0 ) {
                ...
                <tr>
                        ...
                        <a href="<?php echo base_url(); ?>admin/ordenes/procesar/<?php echo $u->id; ?>" ><img src="<?php echo base_url(); ?>assets/img/edit-icon.gif" width="16" height="16" alt="procesar" />  </a>
